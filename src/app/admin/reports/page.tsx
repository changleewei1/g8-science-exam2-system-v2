      ...
      <ul className="grid gap-4 sm:grid-cols-2">
        <li>
          <Link
            ...
            className="block rounded-2xl border border-cyan-200/50 bg-white shadow-[0_8px_28px_-10px_rgba(14,165,233,0.12)] p-5 shadow-md transition hover:border-cyan-400/40"
          >
