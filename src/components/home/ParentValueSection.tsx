      ...
      <div className="mx-auto max-w-6xl">
        <div className="grid gap-10 lg:grid-cols-2 lg:items-center lg:gap-16">
          <div>
            ...
            <h2 className="mt-3 text-balance bg-gradient-to-r from-slate-900 via-cyan-900 to-slate-900 bg-clip-text text-xl font-bold tracking-tight text-transparent sm:text-2xl md:text-3xl">
              家長看得見，學習更安心
            </h2>
          ...
          <ul className={`space-y-4 p-6 md:p-8 ${homeGlassCard}`}>
            {bullets.map((text) => (
              <li key={text} className="flex gap-3 text-sm leading-relaxed text-slate-700 md:text-base">
                <span className="mt-0.5 flex h-6 w-6 shrink-0 items-center justify-center rounded-full border border-cyan-200/80 bg-cyan-50 text-cyan-700">
