  ...
  return (
    <span className="inline-flex flex-col gap-0.5">
      <button
        ...
        className="text-left text-xs font-medium text-slate-600 underline decoration-slate-400 underline-offset-2 disabled:opacity-50"
      >
        {loading ? "處理中…" : "產生家長連結"}
      </button>
      {notice ? <span className="text-[10px] text-cyan-800">{notice}</span> : null}
