    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-wrap gap-2">
        <button
          ...
          className="interactive-btn rounded-xl bg-cyan-600 px-4 py-2.5 text-sm font-medium text-white shadow-md"
        >
          新增學生
        </button>
        <button
      ...
      {notice && (
        <div className="whitespace-pre-wrap rounded-2xl border border-cyan-400/35 bg-cyan-500/10/80 px-4 py-3 text-sm text-teal-950">
          {notice}
        </div>
      )}
      ...
      {showAdd && (
        ...
        >
          ...
          <div className="flex gap-2">
            ...
            <button type="button" onClick={() => setShowAdd(false)} className="text-sm text-slate-400">
              取消
            </button>
          </div>
        </form>
      ...
      {showImport && (
        <form onSubmit={onImport} className="rounded-2xl border border-white/10 bg-white/[0.06] backdrop-blur-md p-5 shadow-md space-y-3 max-w-2xl">
          ...
          <div className="flex gap-2">
            ...
            <button type="button" onClick={() => setShowImport(false)} className="text-sm text-slate-400">
              取消
            </button>
          </div>
        </form>
